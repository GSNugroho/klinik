<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $edit = mysqli_query($koneksi, "UPDATE pasien SET nama_pasien='".$nama."',alamat_pasien='".$alamat."', tempat_lahir='".$tempat_lahir."', tgl_lahir_pasien='".$tgl_lahir."', umur='".$umur."', jk_pasien='".$jenis_kelamin."' WHERE no_rm = '".$norm."'");
