    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="main">
                ...
                <div class="row">
                    <div class="table">
                        <table id="data" class="table hover display responsive compact" cellspace="0" width="100%">
                            <thead>
                                <tr>
                            ...
                            <tbody id="myTable">
                                ...
                                while ($hasil = mysqli_fetch_array($query)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td><a class = 'btn btn-info' href = 'need/detailResep.php?id_resep=" . $hasil['id_resep'] . "'>Detail</a></td>
