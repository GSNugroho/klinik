<ul class="nav nav-sidebar ">               
    ...
    <!-- <li class="<?php //$arrActive['buat_resep'] ?>"><a href="buat_resep.php">Buat Resep</a></li> -->
    <li class="<?= $arrActive['data_obat'] ?>"><a href="data_obat.php">Data Obat</a></li>
    <li class="<?= $arrActive['tambah_obat'] ?>"><a href="tambah_obat_baru.php">Tambah Obat Baru</a></li>
