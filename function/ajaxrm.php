...
hr_pasien, nm_wali, hub_wali, nm_ortu, pkrj_wali, no_bpjs FROM pasien_b LEFT JOIN pasien_bpjs ON pasien_b.no_rm = pasien_bpjs.no_rm_bpjs 
WHERE no_rm='".mysqli_escape_string($koneksi, $_POST['dtrm'])."'");
